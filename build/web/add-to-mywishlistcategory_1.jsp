...
out.println(email);
  ...
  Connection connection = new Dbconn.dbconn().getConnection();
        ...
        String insertQuery = "INSERT INTO wishlist (product_id, email) VALUES (?, ?)";
        try (PreparedStatement preparedStatement = connection.prepareStatement(insertQuery)) {
            ...
            String successMessage = "Added successfully.";
               ...
               // out.println("}).then(function() { window.location.href = 'customers-category.jsp_1'; });");
               out.println("}).then(function() { window.location.href = 'customers-category_1.jsp?brand=" + brand + "'; });");
                out.println("</script>");
