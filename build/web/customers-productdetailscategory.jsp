...
%>                    
				...
				<div class="col-lg-6 product-details">
					...
					<div class="p-review">
						<a href="">3 reviews</a>|<a href="customers-feedback.jsp">Add your review</a>
					</div>
					<div class="quantity">
						<p>Quantity</p>
<!--						<div class="pro-qty"><input type="text" value="1"></div>-->
<!--                                                        <div style="display: flex; align-items: center;">
            <input type="number" class="pro-qty" value="<%= resultSet.getInt("quanity")%>" >
            <button class="updateButton" >Go</button>
        </div>-->
						
						<a href="customers-mycart.jsp">
							<button class="btn btn-primary ml-3 flaticon-bag"
								style="border-radius: 40px; height: 35px;">&nbsp; Add to Cart</button>
						</a>
						<a href="customers-mywishlist.jsp">
...
<!--					<a href="customers-checkout.jsp" class="site-btn">Order NOW</a>-->
						...
						<div class="panel">
							<div class="panel-header" id="headingTwo">
								<button class="panel-link" data-toggle="collapse" data-target="#collapse2"
									aria-expanded="false" aria-controls="collapse2">card details </button>
							</div>
