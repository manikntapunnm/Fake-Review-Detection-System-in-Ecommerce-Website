...
<%
    ...
    if (category != null) {
        ...
        } else if (category.equals("Candidate")) {
            categoryHeader = "Candidate";
        }
    }
%>
         ...
         <!-- Menu Item for Companies Feedback Analysis -->
        <li class="menu-item <%= category.equals("Company") ? "active" : "" %>">
        ...
        <!-- Menu Item for Candidate Feedback Analysis -->
        <li class="menu-item <%= category.equals("Candidate") ? "active" : "" %>">
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> <%= categoryHeader %>    /</span>Feedback Analysis</h4>
            ...
            <!-- Responsive Table -->
            <div class="card">
              <h5 class="card-header"> <%= categoryHeader %></h5>
              <div class="table-responsive text-nowrap">
                <div class="col-12">
                  <canvas id="barChart" width="7" height="2"></canvas>
                </div>
<%@ page import="java.sql.Connection, java.sql.PreparedStatement, java.sql.ResultSet, java.sql.SQLException, java.util.Map, java.util.HashMap" %>
  ...
  <script>
        $(document).ready(function() {
            ...
            $.ajax({
               ...
               url: "fetch-sentiment-data.jsp?categoryHeader=" + encodeURIComponent(categoryHeader),
                method: "GET",
                dataType: "json",
                success: function(data) {
                  const sentimentLabels = ["Very Positive", "Positive", "Neutral", "Negative", "Very Negative"];
                   // const sentimentData = Object.values(data);
