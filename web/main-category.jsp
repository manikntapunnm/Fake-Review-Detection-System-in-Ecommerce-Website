...
<body>
	...
	<section class="hero-section">
		<div class="banner set-bg" data-setbg="img/pexel10.jpeg">
			<h4 class="py-4 text-white">CATEGORY</h4>
	...
	<!-- Banner section end  -->
	<!-- <div class="container-fluid gradient-custom-2 mb-5" style="height: 300px;">
		<div class="row">
			<div class="col-4"></div>
			<div class="col-4">
				<h2 class="text-center text-white " style="margin-top: 110px;">Contact</h2>
				<div class="site-pagination text-center">
					<a href="" style="font-size: larger;">Home</a> /
					<a href="" style="font-size: larger;">Contact</a>
				</div>
			</div>
			<div class="col-4"></div>
		</div>
...
<br><br><br><br> -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-6">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14376.077865872314!2d-73.879277264103!3d40.757667781624285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1546528920522" style="border:0; width: 600px; height: 700px;" allowfullscreen></iframe>
			</div>
		</div>
	</div>
	<div class=""></div>
