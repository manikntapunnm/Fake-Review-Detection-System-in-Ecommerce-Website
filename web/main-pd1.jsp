...
<body>
	...
	<section class="hero-section">
		<div class="banner set-bg" data-setbg="img/pexel10.jpeg">
			<h4 class="py-4 text-white">PRODUCT</h4>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="cart-table card-body">
						<h5>Order Details: #2400</h5>
						<span>May 20,2022, 9:30pm</span> <br><br>
						<h6>Status: &nbsp;<label class="form-label badge" for="form3Example1q"
								style="height: 20px; border-radius: 5px;  background-color:rgb(186, 186, 240);"><a
									href="" style="color:midnightblue;">Processing</a></label></h6>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-12">
					<div class="cart-table card-body">
						...
						<div class="total-cost">
							<h6>Total <span>1,16,709</span></h6>
						</div>
					</div>
				</div>
			</div>
