...
<body>
	...
	<section class="hero-section">
		<div class="banner set-bg" data-setbg="img2/pexel10.jpeg">
			<h4 class="py-4 text-white">MY WISHLIST</h4>
...
try {
    ...
    String sql = "SELECT w.*, p.* FROM wishlist w JOIN products p ON w.product_id = p.product_id WHERE w.email = ?";
										...
										<td class="product-col">
											...
											<div class="pc-title">
												...
												<!-- <p>800</p> -->
                                                                                ...
                                                                                <td> <a href="customers-productdetailshome.jsp?productid=<%= resultSet.getString("product_id")%>"> View</a> </td>
                      
										
										<td class="total-col">
                                                                                  
                                                                                    <h4>  &#8377<span> <%= resultSet.getString("price")%></span></h4>
										</td>
                                                                                
                                                                                
                                                                                     <td> <i class="flaticon-heart"></i> </td>
										<td>
                                                                                    
                                                                                    
                                                                                    
                                                                                    
                                                                                    <a href="customers-mycart.jsp"><i class="flaticon-bag text-dark"></i></a>
                                                                            ...
                                                                            <a href="delete_1.jsp?wishlistid=<%= resultSet.getString("wishlist_id")%>">
                                                                                <span class="icon_close"></span>
                                                                                <i class="fas fa-window-close"></i>
                                                                            </a>
                                                                        </td-->
                                                                                    <td class="shoping__cart__item__close">
    <a href="#" onclick="confirmDelete('<%= resultSet.getString("wishlist_id") %>')">
        <span class="icon_close"></span>
        <i class="fas fa-window-close"></i>
    </a>
</td>
...
<script>
    function confirmDelete(wishlistId) {
        var confirmDelete = confirm("Are you sure you want to delete this item from the wishlist?");
        if (confirmDelete) {
            // User clicked OK, redirect to delete_1.jsp with the wishlistid
            window.location.href = "delete_1.jsp?wishlistid=" + wishlistId;
        } else {
