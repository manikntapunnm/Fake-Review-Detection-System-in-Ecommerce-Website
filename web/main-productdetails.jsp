...
<body>
	...
	<section class="product-section mb-5">
		<div class="container">
			<div class="back-link">
				<a href="customers-category.jsp"> >> Next to Category</a>
			</div>
			<div class="row">
				<div class="col-lg-6">
					<div class="product-pic-zoom">
						<img class="product-big-img" src="img/pd1.webp" alt="">
					</div>
					<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						<div class="product-thumbs-track">
							<div class="pt active" data-imgbigurl="img/single-product/pd2.webp"><img
									src="img/single-product/pd2.webp" alt=""></div>
							<div class="pt" data-imgbigurl="img/single-product/pd3.webp"><img
									src="img/single-product/pd3.webp" alt=""></div>
							<div class="pt" data-imgbigurl="img/single-product/pd4.webp"><img
									src="img/single-product/pd4.webp" alt=""></div>
							<div class="pt" data-imgbigurl="img/single-product/pd5.webp"><img
									src="img/single-product/pd5.webp" alt=""></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 product-details">
					<h2 class="p-title">Vivo Y75 (Dancing Waves, 8GB RAM, 128GB ROM) with No Cost EMI/Additional
						Exchange Offers</h2>
					<p style="font-size: 12px;">M.R.P: <span style="color:darkorange;">25,990.00</span> <br> Deal Price:
						<span style="color: blue;">20,990</span> <br> You Save: <span style="color: blue;">5,000</span>
					</p>
					<!-- <p  style="font-size: 15px;">Deap Price: <span style="color: blue;">24,000</span> </p>
                <p  style="font-size: 15px;">You Save: <span style="color: blue;">10,000</span> </p> -->
					<h4 class="p-stock" style="font-size: 13px;">Available: <span
							style="font-size: 13px; color:rgb(112, 212, 12);">In Stock</span></h4>
					<div class="p-rating">
							...
							<div id="collapse1" class="collapse show" aria-labelledby="headingOne"
								...
								<div class="panel-body">
									<ul>
										...
										<li>
											Screen Size 16.35 Centimetres
										</li>
										<li>
											50MP+8MP+2MP Rear Camera | 44MP Selfie Camera
										</li>
										<li>
											16.71cm (6.44") FHD+ Display
										</li>
										<li>
											Memory & SIM: 8GB RAM | 128GB internal memory | Hybrid Dual SIM (nano+nano)
										</li>
										<li>
											dual-standby (4G).
										</li>
										...
										<li>
											44W fast charging with 4050mAh battery (Type-C).
										</li>
									</ul>
